defmodule SimplePythonNotebook.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: SimplePythonNotebook.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    SimplePythonNotebookWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
